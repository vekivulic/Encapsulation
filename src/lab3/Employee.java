...
public class Employee {
    ...
    */
    ...
    private void meetWithHrForBenefitAndSalryInfo() {
        metWithHr = true;
        report.addDataToReport(firstName + " " + lastName + " met with Hr on "
            + getFormattedDate());
    }
    ...
    private void meetDepartmentStaff() {
        metDeptStaff = true;
        report.addDataToReport(firstName + " " + lastName + " met with Dept. Staff on "
            + getFormattedDate());
    }
    ...
    public void reviewDeptPolicies() {
        ...
        report.addDataToReport(firstName + " " + lastName + " reviewed Dept policies on "
            + getFormattedDate());
    }
    ...
    public void moveIntoCubicle(String cubeId) {
        this.cubeId = cubeId;
        this.movedIn = true;
        report.addDataToReport(firstName + " " + lastName + " moved into cubicle "
